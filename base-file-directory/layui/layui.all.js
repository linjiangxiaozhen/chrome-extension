...
;!function (e) {
 ...
 r.prototype.cache = n, r.prototype.define = function (e, t) {
  ...
  return t ? (r.sort(function (e, n) {
   var r = /^-?\d+$/, o = e[t], a = n[t];
   // updated by xuyefei 排序时对于负数与0的比较存在bug，把0换成一个很小的数，暂定20位有效数字
   if (o === 0) {o = 1 * Math.pow(10, -20)}; if (a === 0) {a = 1 * Math.pow(10, -20)};
 ...
 var o = ".layui-nav", r = "layui-nav-item", c = "layui-nav-bar", u = "layui-nav-tree", d = "layui-nav-child",
     y = "layui-nav-more", h = "layui-anim layui-anim-upbit", f = {
      tabClick: function (t, i, s, o) {
       // modify by xuyefei tab被禁用时不作任何处理
       if ($(this).css("cursor") == "not-allowed" || $(this).attr("disabled")) {
        return;
       }
       o = o || {};
...
layui.define(["laytpl", "laypage", "layer", "form", "util"], function (e) {
 ...
 }, F.prototype.refresh = function (options) {// added by xuyefei
  var that = this;
 ...
 }, // 扩展layui refresh方法只刷新数据，不渲染整个表格 updated by xuyefei
     d.refresh = function (e, t) {
      var i = s(e);
      if (i) {
       var a = c.that[e];
       return a.refresh(t), c.call(a)
      }
     }, d.render = function (e) {
  var t = new F(e);
  return c.call(t)
